...
function CreateSurvey() {
  ...
  return (
    <div className="">
      <h3 className="create-survey-heading">Create Survey</h3>
      {error && <div className="error">{error}</div>}
    <div className="create-survey-card">

    <label><h6>Title:</h6></label>
      <TextField type="text" value={title} onChange={(e) => setTitle(e.target.value)} style={{width:'60%'}} />

      <div>
        <label><h6>Questions:</h6></label>
        {questions.map((q, questionIndex) => (
          <div key={questionIndex} className="question-container">
            ...
            />
       &nbsp; &nbsp; &nbsp;
       <InputLabel style={{color:'#333',fontSize:'1rem',fontStyle: 'cursive'}}>Question Type</InputLabel>
            <FormControl>
